 ...
 */
class Cradle_Module_{{capital name}}_Service_ElasticServiceTest extends PHPUnit_Framework_TestCase
{
    /**
    ...
    /**
     * @covers Cradle\Module\{{capital name}}\Service\ElasticService::__construct
     */
